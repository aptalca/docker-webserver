...
On unRaid, install from the Community Applications and enter the app folder location, server ports and the email and the domain url under advanced view. Note: 
